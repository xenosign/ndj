      ...
      <div className="flex flex-col flex-1 px-6 pt-10 pb-6 gap-6">
        ...
        >
          <div className="flex-1 flex flex-col items-center py-4 gap-1">
            <span className="text-xs font-medium" style={{ color: '#C47B3A' }}>
              현재 체중
            </span>
        ...
        {/* 적들의 댓글 보기 버튼 */}
        <button
          className="w-full h-13 rounded-2xl font-semibold text-sm transition-opacity hover:opacity-85 active:opacity-70 py-4"
        ...
        <Link
          href="#"
          className="flex items-center justify-center w-full h-13 rounded-2xl font-semibold text-sm transition-opacity hover:opacity-85 active:opacity-70 py-4"
